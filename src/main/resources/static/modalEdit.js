                        ...
                        <div class="container_fluid">
                            <div class="row justify-content-center">
                                <div class="col col-sm-6 text-center">
                                    ...
                                    <input type="text" name="name" value="${user.namedItem("name").innerHTML}" class="form-control" id="updateUserFirstName">
                                    <br>
                                    
                                    <label for="updateUserLastName" class="font-weight-bold">Last Name</label>
                                    <input type="text" name="lastName" value="${user.namedItem("lastName").innerHTML}" class="form-control" id="updateUserLastName">
                                    <br>
