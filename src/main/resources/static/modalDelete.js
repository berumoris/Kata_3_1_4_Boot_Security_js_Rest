                        ...
                        <div class="container_fluid">
                            <div class="row justify-content-center">
                                <div class="col col-sm-6 text-center">
                                    ...
                                    <input type="text" value="${user.namedItem("name").innerHTML}" class="form-control" id="userFirstName" disabled>
                                    <br>
                                    
                                    <label for="userLastName" class="font-weight-bold">Last Name</label>
                                    <input type="text" value="${user.namedItem("lastName").innerHTML}" class="form-control" id="userLastName" disabled>
                                    <br>
                                    
                                    <label for="userAge" class="font-weight-bold">Age</label>
                                    <input type="text" value="${user.namedItem("age").innerHTML}" class="form-control" id="userAge" disabled>
                                    <br>
